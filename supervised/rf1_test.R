...
load("rfmodel_pixelandallEBfeat.RData")
...
# init file first
setwd(top.wd)
write.table(header, file="submission9.csv", quote=FALSE,
...
while (TRUE) {
    ...
    write.table(output, file="submission9.csv", append=TRUE,
